...
{
    public partial class JustForYou_WorkOut : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (url == "http://localhost:64945/JustForYou-WorkOut")  // http://localhost:64945/JustForYou-WorkOut IS THE Local JustForYou-WorkOut URL, will change to make more dynamic,  CHECKS IF THE CURRENT PAGE IS THE JustForYou-WorkOut PAGE
            {
