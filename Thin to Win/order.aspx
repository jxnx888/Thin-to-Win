<%@ Page Title="Product" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="order.aspx.cs" Inherits="Thin_to_Win.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row"><%-- row 1 --%>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        [LongDescription], [ImageFile], [UnitPrice] FROM [Product] 
                        ORDER BY [Name]">
                    </asp:SqlDataSource>
                </div>
            </div>   
        ...
        <div class="col-sm-4"><%-- product image column --%>
            <asp:Image ID="imgProduct" style="width:300px; height:300px;" runat="server" />
        </div>
    </div><%-- end of row 1 --%>
    <div class="row"><%-- row 2 --%>
        <div class="col-sm-12">
